      ...
      *| DATE GENERATED: 04/13/2023 15:00                              |
      *| ID: daba9d2c-9e64-4ef6-8f31-51110bdd96a0                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_SQL913                                                   |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          3 AZU00000001 PIC 9(2) OCCURS 2.
          3 AZU00000003 PIC 9(10) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
      ...
      * START
           DISPLAY 'AZU0000I TEST_SQL913 STARTED...'
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF (ZUT000000AD OF ZUT000000AB IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE ZUT000000AD OF ZUT000000AB TO AZU00000001(1)
             MOVE 02 TO AZU00000001(2)
           ...
           IF (ZUT000000AE OF ZUT000000AB IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE ZUT000000AE OF ZUT000000AB TO AZU00000003(1)
             MOVE 1 TO AZU00000003(2)
           ...
           END-IF
      * END
           DISPLAY 'AZU0000I TEST_SQL913 SUCCESSFUL.'
           GOBACK.
       INITIALIZE-PARM.
           EXIT.
       THROW-ASSERTION.
      ...
      *+---------------------------------------------------------------+
      *| TEST_SQL00                                                    |
      *|     THIS PROGRAM IS FOR TEST SQL00                            |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_SQL00'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'LGICDB01'.
       01 BZ-ASSERT.
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          3 AZU0000000D PIC 9(2) OCCURS 2.
          3 AZU0000000F PIC 9(10) OCCURS 2.
          3 AZU00000011 PIC X(10) OCCURS 2.
          3 AZU00000013 PIC X(20) OCCURS 2.
          3 AZU00000015 PIC X(20) OCCURS 2.
          3 AZU00000017 PIC X(4) OCCURS 2.
          3 AZU00000019 PIC X(8) OCCURS 2.
          3 AZU0000001B PIC 9(3) OCCURS 2.
          3 AZU0000001D PIC X(20) OCCURS 2.
          3 AZU0000001F PIC X(20) OCCURS 2.
          3 AZU00000021 PIC X(100) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      *    *** CA-C-FILLER : ZUT00000100
       ...
       PROCEDURE DIVISION USING AZ-TEST
           ZUT0000008B ZUT000000AB.
      * START
           DISPLAY 'AZU0000I TEST_SQL00 STARTED...'
           MOVE 0 TO AZ-TEST-NAME-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-NAME-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      * INITIALIZE PARAMETER
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF (ZUT000000AD OF ZUT000000AB IS NUMERIC)
               AND (ZUT000000AD OF ZUT000000AB = 00) THEN
             CONTINUE
           ELSE
             MOVE ZUT000000AD OF ZUT000000AB TO AZU0000000D(1)
             MOVE 00 TO AZU0000000D(2)
           ...
           IF (ZUT000000AE OF ZUT000000AB IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE ZUT000000AE OF ZUT000000AB TO AZU0000000F(1)
             MOVE 1 TO AZU0000000F(2)
           ...
           AZU0000000F(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000B1 OF ZUT000000B0 OF ZUT000000AB = AZU00000004
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000B1 OF ZUT000000B0 OF ZUT000000AB TO
           AZU00000011(1)
             MOVE AZU00000004 TO AZU00000011(2)
           ...
           AZU00000013(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000B4 OF ZUT000000B0 OF ZUT000000AB = AZU00000006
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000B4 OF ZUT000000B0 OF ZUT000000AB TO
           AZU00000015(1)
             MOVE AZU00000006 TO AZU00000015(2)
           ...
           AZU00000015(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000B5 OF ZUT000000B0 OF ZUT000000AB = AZU00000007
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000B5 OF ZUT000000B0 OF ZUT000000AB TO
           AZU00000017(1)
             MOVE AZU00000007 TO AZU00000017(2)
           ...
           AZU00000017(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000B6 OF ZUT000000B0 OF ZUT000000AB = AZU00000008
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000B6 OF ZUT000000B0 OF ZUT000000AB TO
           AZU00000019(1)
             MOVE AZU00000008 TO AZU00000019(2)
           ...
           AZU0000001B(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000B8 OF ZUT000000B0 OF ZUT000000AB = AZU00000009
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000B8 OF ZUT000000B0 OF ZUT000000AB TO
           AZU0000001D(1)
             MOVE AZU00000009 TO AZU0000001D(2)
           ...
           AZU0000001D(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000B9 OF ZUT000000B0 OF ZUT000000AB = AZU0000000A
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000B9 OF ZUT000000B0 OF ZUT000000AB TO
           AZU0000001F(1)
             MOVE AZU0000000A TO AZU0000001F(2)
           ...
           AZU0000001F(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF ZUT000000BA OF ZUT000000B0 OF ZUT000000AB = AZU0000000B
           THEN
             CONTINUE
           ELSE
             MOVE ZUT000000BA OF ZUT000000B0 OF ZUT000000AB TO
           AZU00000021(1)
             MOVE AZU0000000B TO AZU00000021(2)
           ...
           END-IF
      * END
           DISPLAY 'AZU0000I TEST_SQL00 SUCCESSFUL.'
           GOBACK.
       INITIALIZE-PARM.
           EXIT.
       THROW-ASSERTION.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           WHEN SPACE
             CONTINUE
           WHEN 'SQL913'
             PERFORM CHECK-REC-SQL913
             MOVE 0 TO RETURN-CODE
           WHEN 'SQL00'
             PERFORM CHECK-REC-SQL00
             MOVE 0 TO RETURN-CODE
           WHEN OTHER
             CONTINUE
           END-EVALUATE.
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE 'daba9d2c-9e64-4ef6-8f31-51110bdd96a0'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
           ...
           IF AZ-OUT-PARM-NUM = 1 AND
             ...
             EVALUATE AZ-TEST(1:AZ-TEST-LEN)
               WHEN SPACE
                 CONTINUE
               WHEN 'SQL913'
                 PERFORM O00E70-SQL913
                 CONTINUE
               WHEN 'SQL00'
                 PERFORM O00E70-SQL00
                 CONTINUE
               WHEN OTHER
                 CONTINUE
             END-EVALUATE
