      ...
      *| DATE GENERATED: 01/14/2021 11:06                              |
      *| ID: 7ccdfbd6-1f73-4680-a48e-298e3e67ff49                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_SQLT913                                                  |
      *|     THIS PROGRAM IS FOR TEST SQLT913                          |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_SQLT913'.
       DATA DIVISION.
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT0000001C PIC X(6) OCCURS 2.
          3 ZUT0000001E PIC 9(2) OCCURS 2.
          3 ZUT00000020 PIC 9(10) OCCURS 2.
          3 ZUT00000022 PIC X(10) OCCURS 2.
          3 ZUT00000024 PIC X(20) OCCURS 2.
          3 ZUT00000026 PIC X(10) OCCURS 2.
          3 ZUT00000028 PIC X(20) OCCURS 2.
          3 ZUT0000002A PIC X(4) OCCURS 2.
          3 ZUT0000002C PIC X(8) OCCURS 2.
          3 ZUT0000002E PIC 9(3) OCCURS 2.
          3 ZUT00000030 PIC X(20) OCCURS 2.
          3 ZUT00000032 PIC X(20) OCCURS 2.
          3 ZUT00000034 PIC X(100) OCCURS 2.
          3 ZUT00000036 PIC X(32267) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000010 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT0000001C(1)
             MOVE ZUT00000010 TO ZUT0000001C(2)
           ...
           IF (CA-CUSTOMER-NUM OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-CUSTOMER-NUM OF DFHCOMMAREA TO ZUT00000020(1)
             MOVE 1 TO ZUT00000020(2)
           ...
           TO ZUT00000022(1)
             MOVE ZUT00000011 TO ZUT00000022(2)
           ...
           TO ZUT00000024(1)
             MOVE ZUT00000012 TO ZUT00000024(2)
           ...
           ZUT00000026(1)
             MOVE ZUT00000013 TO ZUT00000026(2)
           ...
           TO ZUT00000028(1)
             MOVE ZUT00000014 TO ZUT00000028(2)
           ...
           TO ZUT0000002A(1)
             MOVE ZUT00000015 TO ZUT0000002A(2)
           ...
           ZUT0000002C(1)
             MOVE ZUT00000016 TO ZUT0000002C(2)
           ...
           DFHCOMMAREA TO ZUT0000002E(1)
             MOVE 0 TO ZUT0000002E(2)
           ...
           DFHCOMMAREA TO ZUT00000030(1)
             MOVE ZUT00000017 TO ZUT00000030(2)
           ...
           TO ZUT00000032(1)
             MOVE ZUT00000018 TO ZUT00000032(2)
           ...
           DFHCOMMAREA TO ZUT00000034(1)
             MOVE ZUT00000019 TO ZUT00000034(2)
           ...
           TO ZUT00000036(1)
             MOVE ZUT0000001A TO ZUT00000036(2)
           ...
           END-IF
      * END
           DISPLAY 'TEST_SQLT913 SUCCESSFUL.'
           GOBACK.
       INITIALIZE-PARM.
           EXIT.
       THROW-ASSERTION.
      ...
      *     CALL 'XCHRFLTR' USING TRACE-LEN OF BZ-TRACE AZ-TRACE-PTR
           CALL BZUTRACE USING BZ-TRACE
           EXIT.
       END PROGRAM TEST_SQLT913.
      *+---------------------------------------------------------------+
      *| TEST_SQLT100                                                  |
      *|     THIS PROGRAM IS FOR TEST SQLT100                          |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_SQLT100'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'LGICDB01'.
       01 BZ-ASSERT.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT0000006C.
            ...
            5 PIC X(12) DISPLAY VALUE ' DFHCOMMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000053 PIC X(6) OCCURS 2.
          3 ZUT00000055 PIC 9(2) OCCURS 2.
          3 ZUT00000057 PIC 9(10) OCCURS 2.
          3 ZUT00000059 PIC X(10) OCCURS 2.
          3 ZUT0000005B PIC X(20) OCCURS 2.
          3 ZUT0000005D PIC X(10) OCCURS 2.
          3 ZUT0000005F PIC X(20) OCCURS 2.
          3 ZUT00000061 PIC X(4) OCCURS 2.
          3 ZUT00000063 PIC X(8) OCCURS 2.
          3 ZUT00000065 PIC 9(3) OCCURS 2.
          3 ZUT00000067 PIC X(20) OCCURS 2.
          3 ZUT00000069 PIC X(20) OCCURS 2.
          3 ZUT0000006B PIC X(100) OCCURS 2.
          3 ZUT0000006D PIC X(32267) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      * SET INPUT VALUE
           ...
           MOVE 72438 TO EIBTIME OF DFHEIBLK
           MOVE 120301 TO EIBDATE OF DFHEIBLK
           MOVE ZUT00000037 TO EIBTRNID OF DFHEIBLK
           MOVE 94905 TO EIBTASKN OF DFHEIBLK
           MOVE ZUT00000038 TO EIBTRMID OF DFHEIBLK
           MOVE 0 TO DFHEIGDI OF DFHEIBLK
           MOVE 1848 TO EIBCPOSN OF DFHEIBLK
           MOVE 32500 TO EIBCALEN OF DFHEIBLK
           MOVE ZUT00000039 TO EIBAID OF DFHEIBLK
           MOVE ZUT0000003A TO EIBFN-AZ OF DFHEIBLK
           MOVE ZUT0000003B TO EIBRSRCE OF DFHEIBLK
           MOVE 0 TO EIBRESP OF DFHEIBLK
           MOVE 0 TO EIBRESP2 OF DFHEIBLK
           MOVE ZUT0000003C TO CA-REQUEST-ID OF DFHCOMMAREA
           MOVE 0 TO CA-RETURN-CODE OF DFHCOMMAREA
           MOVE 1 TO CA-CUSTOMER-NUM OF DFHCOMMAREA
           MOVE ZUT0000003D TO CA-FIRST-NAME OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT0000003E TO CA-LAST-NAME OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT0000003F TO CA-DOB OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT00000040 TO CA-HOUSE-NAME OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT00000041 TO CA-HOUSE-NUM OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT00000042 TO CA-POSTCODE OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE 0 TO CA-NUM-POLICIES OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT00000043 TO CA-PHONE-MOBILE OF CA-CUSTOMER-REQUEST
           OF DFHCOMMAREA
           MOVE ZUT00000044 TO CA-PHONE-HOME OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA
           MOVE ZUT00000045 TO CA-EMAIL-ADDRESS OF CA-CUSTOMER-REQUEST
           OF DFHCOMMAREA
           MOVE ZUT00000046 TO CA-POLICY-DATA OF CA-CUSTOMER-REQUEST
           OF DFHCOMMAREA
      * CALL TEST PROGRAM
           DISPLAY 'CALL LGICDB01'
           CALL PROGRAM-NAME
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000047 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000053(1)
             MOVE ZUT00000047 TO ZUT00000053(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000052
             MOVE LENGTH OF ZUT00000052 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000053(1)
             MOVE 6 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000053(2)
             MOVE 6 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000055(1)
             MOVE 01 TO ZUT00000055(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000054
             MOVE LENGTH OF ZUT00000054 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000055(1)
             MOVE 2 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000055(2)
             MOVE 2 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-CUSTOMER-NUM OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-CUSTOMER-NUM OF DFHCOMMAREA TO ZUT00000057(1)
             MOVE 1 TO ZUT00000057(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000056
             MOVE LENGTH OF ZUT00000056 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000057(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000057(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA
           TO ZUT00000059(1)
             MOVE ZUT00000048 TO ZUT00000059(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000058
             MOVE LENGTH OF ZUT00000058 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000059(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000059(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA
           TO ZUT0000005B(1)
             MOVE ZUT00000049 TO ZUT0000005B(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000005A
             MOVE LENGTH OF ZUT0000005A TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000005B(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000005B(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-DOB OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA TO
           ZUT0000005D(1)
             MOVE ZUT0000004A TO ZUT0000005D(2)
           ...
           ELSE
             MOVE CA-HOUSE-NAME OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA
           TO ZUT0000005F(1)
             MOVE ZUT0000004B TO ZUT0000005F(2)
           ...
           ELSE
             MOVE CA-HOUSE-NUM OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA
           TO ZUT00000061(1)
             MOVE ZUT0000004C TO ZUT00000061(2)
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA TO
           ZUT00000063(1)
             MOVE ZUT0000004D TO ZUT00000063(2)
           ...
           ELSE
             MOVE CA-NUM-POLICIES OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA TO ZUT00000065(1)
             MOVE 0 TO ZUT00000065(2)
           ...
           ELSE
             MOVE CA-PHONE-MOBILE OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA TO ZUT00000067(1)
             MOVE ZUT0000004E TO ZUT00000067(2)
           ...
           ELSE
             MOVE CA-PHONE-HOME OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA
           TO ZUT00000069(1)
             MOVE ZUT0000004F TO ZUT00000069(2)
           ...
           ELSE
             MOVE CA-EMAIL-ADDRESS OF CA-CUSTOMER-REQUEST OF
           DFHCOMMAREA TO ZUT0000006B(1)
             MOVE ZUT00000050 TO ZUT0000006B(2)
           ...
           ELSE
             MOVE CA-POLICY-DATA OF CA-CUSTOMER-REQUEST OF DFHCOMMAREA
           TO ZUT0000006D(1)
             MOVE ZUT00000051 TO ZUT0000006D(2)
           ...
           END-IF
      * END
           DISPLAY 'TEST_SQLT100 SUCCESSFUL.'
           GOBACK.
       INITIALIZE-PARM.
           EXIT.
       THROW-ASSERTION.
             ...
             IF AZ-OPT-RC = 0 THEN
               ...
               EVALUATE AZ-TEST(1:AZ-TEST-LEN)
                 WHEN SPACE
                   CONTINUE
                 WHEN 'SQLT913'
                   PERFORM O0E080-SQLT913
                   CONTINUE
                 WHEN 'SQLT100'
                   PERFORM O0E080-SQLT100
                   CONTINUE
                 WHEN OTHER
                   CONTINUE
                 END-EVALUATE
           ...
           IF AZ-OUT-PARM-NUM = 1 AND
             ...
             EVALUATE AZ-TEST(1:AZ-TEST-LEN)
               WHEN SPACE
                 CONTINUE
               WHEN 'SQLT913'
                 PERFORM O00E70-SQLT913
                 CONTINUE
               WHEN 'SQLT100'
                 PERFORM O00E70-SQLT100
                 CONTINUE
               WHEN OTHER
                 CONTINUE
             END-EVALUATE
           ...
           IF AZ-OUT-PARM-NUM = 1 AND
             ...
             EVALUATE AZ-TEST(1:AZ-TEST-LEN)
               WHEN SPACE
                 CONTINUE
               WHEN 'SQLT913'
                 PERFORM I00E70-SQLT913
                 CONTINUE
               WHEN 'SQLT100'
                 PERFORM I00E70-SQLT100
                 CONTINUE
               WHEN OTHER
                 CONTINUE
             END-EVALUATE
